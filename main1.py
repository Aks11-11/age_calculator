...
root.title("Ak's Age Calculator")

photo = PhotoImage(file="/Users/akshat/Desktop/icons/application.png")
...
def calculateAge():
    ...
    Label(text=f"{nameValue.get()} your age is {age}", font=(None, 30)).place(x=300, y=500)
